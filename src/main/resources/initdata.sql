...
INSERT IGNORE INTO `menu` (`id`, `active`, `crt_date`, `upd_date`, `expanded`, `icon`, `order_seq`, `parent_id`, `name`, `target`, `url`) VALUES
	...
	(4, b'1', '2018-10-25 18:26:20', '2018-10-25 18:26:20', b'1', 'fas fa-th-list', 1, -1, 'Menu', b'0', '/admin/menu'),
	(5, b'1', '2018-10-26 14:47:09', '2018-10-26 14:57:18', b'1', 'fas fa-clipboard-list', 2, -1, 'Category', b'0', '/admin/category'),
