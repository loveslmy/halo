                        ...
                        <form method="post" class="form-horizontal" id="anatoleSnsOptions">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-primary btn-sm pull-right"
                                        onclick="saveThemeOptions('anatoleSnsOptions')">保存设置
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="tab-pane" id="style">
                        <form method="post" class="form-horizontal" id="anatoleStyleOptions">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="anatoleStylePostTitleLower"
                                           class="col-sm-4 control-label">文章标题大写：</label>
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    <label for="anatoleStyleBlogTitleLower"
                                           class="col-sm-4 control-label">博客标题大写：</label>
                                    <div class="col-sm-8">
                                        <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="3" id="anatoleStyleSelf"
                                                  name="anatole_style_self"
                                                  style="resize: none">${options.anatole_style_self?if_exists}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="box-footer">
                                <button type="button" class="btn btn-primary btn-sm pull-right"
                                        onclick="saveThemeOptions('anatoleStyleOptions')">保存设置
                                </button>
                            </div>
                        </form>
                    </div>
