        ...
        <div class="col-lg-6 attachDesc">
            <div class="box box-solid">
                ...
                <form action="/admin/page/gallery/save" method="post" class="form-horizontal" id="galleryForm">
                    <div class="box-body">
                        <input type="hidden" code="${gallery.galleryId?c}" name="galleryId">
                        <div class="form-group">
                            <label for="galleryName" class="col-sm-2 control-label">图片名称：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="galleryName" name="galleryName" code="${gallery.galleryName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="galleryDesc" class="col-sm-2 control-label">图片描述：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="galleryDesc" name="galleryDesc" code="${gallery.galleryDesc?if_exists}" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="galleryDate" class="col-sm-2 control-label">图片日期：</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="galleryDate" name="galleryDate" code="${gallery.galleryDate?if_exists}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="galleryLocation" class="col-sm-2 control-label">拍摄地点：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="galleryLocation" name="galleryLocation" code="${gallery.galleryLocation?if_exists}" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="galleryUrl" class="col-sm-2 control-label">图片地址：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="galleryUrl" name="galleryUrl" code="${gallery.galleryUrl}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="galleryUrl" class="col-sm-2 control-label">缩略图地址：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="galleryThumbnailUrl" name="galleryThumbnailUrl" code="${gallery.galleryThumbnailUrl}">
                            </div>
                        </div>
                    </div>
