...
public class FrontIndexController extends BaseController {
    ...
    public String index(Model model, @PathVariable(value = "page") int page) {
    ...
    @ResponseBody
    public List<Post> ajaxIndex(@PathParam(value = "page") int page) {
        // 文章数据，只获取文章，没有分页
        int pageSize = getPageSize();
        Pageable pageable = PageRequest.of(page - 1, pageSize, POST_SORT);
        return postService.findPostByStatus(pageable).getContent();
    }
