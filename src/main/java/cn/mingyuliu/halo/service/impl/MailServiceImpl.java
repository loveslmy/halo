...
public class MailServiceImpl implements MailService {
    ...
    public void sendMail(String to, String subject, String content) {
        ...
        HaloUtils.configMail(
                optionHolder.get(Option.MAIL_SMTP_HOST),
                optionHolder.get(Option.MAIL_SMTP_USERNAME),
                optionHolder.get(Option.MAIL_SMTP_PASSWORD));
        try {
            OhMyEmail.subject(subject)
                    .from(optionHolder.get(Option.MAIL_FROM_NAME))
                    .to(to)
                    .text(content)
                    .send();
        } catch (Exception e) {
